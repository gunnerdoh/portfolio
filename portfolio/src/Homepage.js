...
function dateString() {
    ...
    return (
        <div>
            <p className="font-raleway text-xl text-gray-300">Click a word on the left to see more.</p>
            <p className="font-raleway text-xl text-gray-300">{date} ~</p>
        </div>
    );
}
            ...
            <div className='min-h-screen px-20 py-10 ps-30'>
                <div className='flex flex-row justify-between mb-5'>
                    <div>
                        ...
                        <p className="font-averia text-l font-light text-black">
                            gunnerdoh@gmail.com
                        </p>
                    </div>
                ...
                <div className="flex flex-row justify-between">
                    <div className="flex flex-col align-left w-1/2">
                        ...
                        <a href="./resume.pdf" className="font-raleway text-2xl font-light text-black " target="_blank" rel="noopener noreferrer">
                            RESUME
                        </a> 
                        <Mountain />
                    </div>
                    <p className="p-auto m-auto text-center text-3xl font-raleway"></p>
                </div>
                ...
                `}>
                    <h2 className="text-2xl flex-none font-bold mb-4 text-gray-800">
                        About
                    </h2>
