    ...
    return (
        <div className="px-10 md:px-60">
            ...
            <div>
                ...
                <a href="https://www.youtube.com/watch?v=HS9Buft_WVg" target="_blank" rel="noopener noreferrer" className="block pt-6">
                    <p className="font-semibold text-xl hover:text-blue-600">🎥 The Weight ➚</p>
                    <p className="mb-6">Me and my friend's cover of The Band's hit song.</p>
                </a>
                
                <a href="https://sites.google.com/view/collection-2/home?authuser=1" target="_blank" rel="noopener noreferrer" className="block pt-6">
                    <p className="font-semibold text-xl hover:text-blue-600">📄 Freedoh Studios [ 2019-2020 ] ➚</p>
